...
import { iotProjects } from "@/app/work/work-data/iot-projects";
import { webProjects } from "@/app/work/work-data/web-projects";
import { mobileProjects } from "@/app/work/work-data/mobile-projects";
import { aiProjects } from "@/app/work/work-data/ai-projects";
...
export default function SaaSServicePage() {
    return (
        <div className="space-y-12">
            <div className="mx-auto max-w-screen-xl px-4 pt-10 sm:px-6 lg:px-10 xl:px-16">
                <h1 className="text-3xl font-black tracking-tight text-white sm:text-4xl" style={{ fontFamily: "var(--font-display)" }}>
                    SaaS Products for Indian SMEs
                </h1>
                <p className="mt-3 max-w-2xl text-base text-zinc-400">
                    Ready-built, industry-specific SaaS — TextileBridge, CafeBridge, TurfBridge and more — deployable in weeks, not months.
                </p>
            </div>
