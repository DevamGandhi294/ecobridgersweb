  ...
  return (
    <div className="flex flex-col overflow-x-hidden">
      <ScrollToggleHero
        ...
        pretitle1="Innovative companies, SaaS, startups"
        title1={<>Activate your<br/>brand</>}
        subtitle1="We apply AI/ML techniques to enhance monitoring systems with smarter insights, predictive alerts, and intelligent automation."
        pretitle2="Data-driven automation"
        title2={<>Awaken your<br/>growth</>}
        subtitle2="Harness real-time data into predictive models and actionable signals for better decisions, instantly."
      />
