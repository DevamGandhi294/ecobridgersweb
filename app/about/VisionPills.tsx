...
const visionPills = [
    {
        ...
        text: "#111111",
        border: "#7fd186",
        desc: "We build systems tested against real-world conditions, not just demo environments. Every project starts with understanding the actual operational problem — not the surface-level symptom.",
    },
    {
        icon: "🛡️",
        label: "Works in Real Environments",
        color: "#22d3ee",
        bg: "#d6dd57",
        text: "#111111",
        border: "#c7ce50",
        desc: "Field-tested hardware and robust backends that perform under load, network issues and edge cases — not just in ideal conditions that never exist outside a lab.",
    },
    {
        icon: "📈",
        ...
        text: "#ffffff",
        border: "#6e72ff",
        desc: "Modular architecture designed to grow with you. Adding new locations, users, sensors or features should never require rebuilding from scratch.",
    },
    {
        icon: "💰",
        label: "Priced for the Real Market",
        color: "#fb7185",
        bg: "#a78bfa",
        text: "#111111",
        border: "#9f84ef",
        desc: "Clean code, clear documentation and smart component choices that keep costs low and handovers smooth. No vendor lock-in by design — you own everything we build.",
    },
];
