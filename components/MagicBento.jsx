...
// ── UPDATED: your Why EcoBridges data ──
const cardData = [
  {
    color: 'rgba(7, 65, 43, 0.12)', 
    label: '🔗',
    title: 'Vision to Execution',
    description: 'Clear bridge between vision and execution',
  },
  {
    color: 'rgba(7, 65, 43, 0.12)', 
    label: '💰',
  ...
  },
  {
    ...
    description: 'Strong hardware + software integration',
  },
  {
    color: 'rgba(7, 65, 43, 0.12)', 
    label: '📦',
    title: 'Proven Tech Stack',
    description: 'One proven tech stack for reliability',
  },
  {
    color: 'rgba(7, 65, 43, 0.12)', 
    label: '🤝',
    title: 'Structured Workflows',
    description: 'Team-based structured workflows',
  },
  {
    color: 'rgba(7, 65, 43, 0.12)', 
    label: '🚀',
    title: 'Built for Scale',
    description: 'Built for startups, institutions & industries',
  },
];
            ...
            return (
              <ParticleCard key={index} {...cardProps} disableAnimations={shouldDisableAnimations} particleCount={particleCount} glowColor={glowColor} enableTilt={enableTilt} clickEffect={clickEffect} enableMagnetism={enableMagnetism}>
                <div className="magic-bento-card__header">
                  {/* emoji icon as label */}
                  <div className="magic-bento-card__label" style={{ fontSize: '2rem' }}>{card.label}</div>
                </div>
